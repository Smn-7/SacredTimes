...
// DELETE THIS LINE: import Layout from '../components/Layout'; 
    ...
    <>  {/* CHANGED: Was <Layout> */}
      ...
      <section className="hero">
        <div className="hero-text">
          ...
          <Link href="#shop-section" scroll={false} className="btn btn-primary">
            Explore Collections
          </Link>
        </div>
          ...
          {faiths.map((faith, index) => (
            ...
            >
              ...
              <div className="faith-content">
                ...
                <Link href={`/shop/${faith.id}`} className="btn btn-outline" style={{ borderColor: faith.color, color: faith.color }}>
                  View Collection
                </Link>
              </div>
            </section>
